...
function page() {
  ...
  return (
    ...
    <Grid sx={{mt:'3vh', mb:'4vh'}} container rowSpacing={4} columnSpacing={8}>
        ...
        <Typography sx={{ mx:'2xh', mb:'3vh'}} variant='h6'>
    ...
    <Grid sx={{my:'4vh'}} container rowSpacing={4} columnSpacing={8}>
    ...
    <Grid sx={{my:'4vh'}} container rowSpacing={4} columnSpacing={8}>
        ...
        <Typography sx={{ mx:'2xh', mb:'3vh', textAlign:'center'}} variant='h6'>
